...
func UpdateAppointment(id int, dto appointment_models.UpdateAppointmentDTO) ([]rules.ValidationError, *appointment_models.Appointment) {
	...
	appointment := appointment_models.UpdateAppointment(id, dto)
